  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
      ...
      <div className={`relative w-full max-w-2xl border rounded-[4rem] shadow-3xl overflow-hidden ring-1 ring-white/10 ${isDarkMode ? 'bg-slate-900 border-slate-800 shadow-black/50' : 'bg-white border-slate-200 shadow-slate-300'}`}>
        <div className="p-16">
          <h2 className={`text-4xl font-black tracking-tighter uppercase italic mb-4 leading-tight ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{categoryToEdit ? 'Editar Categoria' : 'Nova Categoria'}</h2>
          <p className="text-[10px] font-black text-blue-500 uppercase tracking-[0.4em] mb-12">Setor Operacional</p>
