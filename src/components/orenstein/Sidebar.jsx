...
import {
  ...
  Terminal as TerminalIcon, User, LogOut, BarChart2, TrendingUp,
} from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto px-4 space-y-10 custom-scrollbar">
        ...
        <section>
          ...
          <div className="space-y-1.5">
            ...
            <button onClick={() => { setActiveTab("Analytics"); setActiveApp(null); }} className={`w-full flex items-center gap-4 px-5 py-3 rounded-2xl text-xs font-bold transition-all border ${activeTab === 'Analytics' ? 'bg-indigo-500/10 border-indigo-500/20 text-indigo-500 shadow-sm' : 'text-slate-500 border-transparent hover:bg-black/5'}`}>
