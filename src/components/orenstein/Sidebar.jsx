                        ...
                        {(dragProvided, snapshot) => (
                          <div
                            ...
                            style={{
                              ...
                              boxShadow: snapshot.isDragging ? '0 25px 50px -12px rgba(59,130,246,0.25)' : undefined,
                              outline: snapshot.isDragging ? '1px solid rgba(59,130,246,0.4)' : undefined,
                              borderRadius: '1rem',
                          ...
                          >
                            <div className="flex items-center gap-1">
                              <div
                                ...
                                className={`p-1.5 rounded-xl flex-shrink-0 ${isDarkMode ? 'text-slate-600 hover:text-slate-400' : 'text-slate-300 hover:text-slate-500'}`}
                                style={{ cursor: 'grab' }}
