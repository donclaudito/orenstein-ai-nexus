...
export default function Sidebar({
  ...
  const handleDragEnd = (result) => {
    ...
    onReorderWorkspace?.(fromIndex, toIndex, sortedWorkspaces);
  };
                      ...
                      <Draggable key={ws.id} draggableId={ws.id} index={index}>
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`space-y-1 rounded-2xl transition-all duration-200 ${
                              snapshot.isDragging
                                ? (isDarkMode
                                    ? 'opacity-90 shadow-2xl shadow-blue-500/20 ring-1 ring-blue-500/40 bg-slate-900'
                                    : 'opacity-90 shadow-2xl shadow-blue-500/20 ring-1 ring-blue-500/40 bg-white')
                                : ''
                            }`}
                          >
                            <div className="flex items-center gap-1">
                              ...
                              <div
                                ...
                                className={`p-1.5 rounded-xl cursor-grab active:cursor-grabbing transition-opacity flex-shrink-0 ${
                                  isDarkMode
